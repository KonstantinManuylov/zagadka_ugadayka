...
while (tries <= 3)
{
    ...
    if (numberB == numberA)
    {
        Console.WriteLine("Победа!!! Два полцарства в твоих руках :) \nЗагаданное число было: " + numberA + ".");
        break;
    }
    if (numberA < numberB)
    {
